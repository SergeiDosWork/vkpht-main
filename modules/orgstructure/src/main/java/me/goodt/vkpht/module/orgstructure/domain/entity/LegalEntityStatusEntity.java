...
@Entity
@NoArgsConstructor
@Table(name = "org_legal_entity_status")
public class LegalEntityStatusEntity extends IntDomainObject implements ArchivableEntity {
    ...
    public LegalEntityStatusEntity(Integer id, String name) {
        setId(id);
        this.name = name;
    }
}
