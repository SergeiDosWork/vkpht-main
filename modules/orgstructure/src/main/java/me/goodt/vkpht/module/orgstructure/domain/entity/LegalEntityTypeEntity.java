...
@Entity
@NoArgsConstructor
@Table(name = "org_legal_entity_type")
public class LegalEntityTypeEntity extends IntDomainObject implements ArchivableEntity {
    ...
    public LegalEntityTypeEntity(Integer id, String name) {
        setId(id);
        this.name = name;
    }
}
