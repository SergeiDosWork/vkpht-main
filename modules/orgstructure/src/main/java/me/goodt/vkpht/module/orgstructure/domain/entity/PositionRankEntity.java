...
@Entity
@NoArgsConstructor
@Table(name = "org_position_rank")
public class PositionRankEntity extends DomainObject implements ArchivableEntity {
    ...
    public PositionRankEntity(Long id, String fullName, String shortName, String abbreviation) {
        setId(id);
