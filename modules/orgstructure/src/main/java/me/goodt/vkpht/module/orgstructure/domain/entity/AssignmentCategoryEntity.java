...
@Entity
@NoArgsConstructor
@Table(name = "org_assignment_category")
public class AssignmentCategoryEntity extends DomainObject implements ArchivableEntity {
    ...
    public AssignmentCategoryEntity(Long id, String fullName, String shortName, String abbreviation) {
        setId(id);
