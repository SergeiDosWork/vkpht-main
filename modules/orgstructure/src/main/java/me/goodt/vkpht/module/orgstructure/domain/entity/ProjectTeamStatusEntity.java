...
@Entity
@NoArgsConstructor
@Table(name = "org_project_team_status")
public class ProjectTeamStatusEntity extends DomainObject implements ArchivableEntity {
    ...
    public ProjectTeamStatusEntity(Date dateFrom, Date dateTo, String name) {
