...
@Entity
@NoArgsConstructor
@Table(name = "org_citizenship")
public class CitizenshipEntity extends DomainObject implements ArchivableEntity {
    ...
    public CitizenshipEntity(Long id, String name, String shortName, Date dateFrom, Date dateTo) {
        setId(id);
        this.name = name;
