...
@Entity
@NoArgsConstructor
@Table(name = "org_project_type")
public class ProjectTypeEntity extends IntDomainObject implements ArchivableEntity {

    public ProjectTypeEntity(Integer id, String name) {
        setId(id);
        this.name = name;
    }
