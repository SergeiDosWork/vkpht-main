...
@Entity
@NoArgsConstructor
@Table(name = "org_work_function_status")
public class WorkFunctionStatusEntity extends IntDomainObject implements ArchivableEntity {
    ...
    public WorkFunctionStatusEntity(Integer id, String name) {
        setId(id);
        this.name = name;
    }
}
