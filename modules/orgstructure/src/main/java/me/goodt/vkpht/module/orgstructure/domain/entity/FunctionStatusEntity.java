...
@Entity
@NoArgsConstructor
@Table(name = "org_function_status")
public class FunctionStatusEntity extends IntDomainObject implements ArchivableEntity {
    ...
    public FunctionStatusEntity(Integer id, String name) {
        setId(id);
        this.name = name;
    }
}
