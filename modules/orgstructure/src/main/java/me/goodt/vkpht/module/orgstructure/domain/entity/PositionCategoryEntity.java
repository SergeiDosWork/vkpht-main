...
@Entity
@NoArgsConstructor
@Table(name = "org_position_category")
public class PositionCategoryEntity extends DomainObject implements ArchivableEntity {
    ...
    public PositionCategoryEntity(String fullName, String shortName, String abbreviation) {
        super();
