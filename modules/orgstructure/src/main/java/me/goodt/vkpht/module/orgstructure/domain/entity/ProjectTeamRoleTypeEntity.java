...
@Entity
@NoArgsConstructor
@Table(name = "org_project_team_role_type")
public class ProjectTeamRoleTypeEntity extends DomainObject implements ArchivableEntity {
    ...
    public ProjectTeamRoleTypeEntity(Date dateFrom, Date dateTo, String name) {
