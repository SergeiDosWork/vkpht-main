...
@Entity
@NoArgsConstructor
@Table(name = "org_substitution_type")
public class SubstitutionTypeEntity extends IntDomainObject implements ArchivableEntity {

    public SubstitutionTypeEntity(Integer id, String fullName, String shortName, String abbreviation) {
        setId(id);
