...
@Entity
@NoArgsConstructor
@Table(name = "org_position_status")
public class PositionStatusEntity extends IntDomainObject implements ArchivableEntity {
    ...
    public PositionStatusEntity(Integer id, String fullName, String shortName, String abbreviation) {
        setId(id);
