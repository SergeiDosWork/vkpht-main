...
@Entity
@NoArgsConstructor
@Table(name = "org_assignment_type")
public class AssignmentTypeEntity extends IntDomainObject implements ArchivableEntity {
    ...
    public AssignmentTypeEntity(Integer id, String fullName, String shortName, String abbreviation) {
        setId(id);
