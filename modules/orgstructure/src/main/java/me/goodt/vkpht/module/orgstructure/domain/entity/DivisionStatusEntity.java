...
@Entity
@NoArgsConstructor
@Table(name = "org_division_status")
public class DivisionStatusEntity extends IntDomainObject implements ArchivableEntity {
    ...
    public DivisionStatusEntity(Integer id, String name) {
        setId(id);
        this.name = name;
    }
}
