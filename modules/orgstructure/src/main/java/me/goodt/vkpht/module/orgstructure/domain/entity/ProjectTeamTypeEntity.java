...
@Entity
@NoArgsConstructor
@Table(name = "org_project_team_type")
public class ProjectTeamTypeEntity extends DomainObject implements ArchivableEntity {
    ...
    public ProjectTeamTypeEntity(Date dateFrom, Date dateTo, String name) {
